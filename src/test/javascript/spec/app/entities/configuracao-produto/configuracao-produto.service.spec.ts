...
describe('Service Tests', () => {
    ...
    describe('ConfiguracaoProduto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConfiguracaoProdutoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/configuracao-produtos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConfiguracaoProduto', () => {
