...
public class LayoutResource {
    ...
    public ResponseEntity<LayoutDTO> updateLayout(@Valid @RequestBody LayoutDTO layoutDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, layoutDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<LayoutDTO>> getAllLayouts(Pageable pageable) {
        log.debug("REST request to get a page of Layouts");
        Page<LayoutDTO> page = layoutService.findAll(pageable);
